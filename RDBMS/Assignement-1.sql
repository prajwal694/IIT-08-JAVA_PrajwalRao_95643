...
mysql> CREATE TABLE S (S# CHAR(5) NOT NULL, Sname CHAR(20), status
...
mysql> CREATE TABLE P (P# CHAR(6) NOT NULL, Pname CHAR(20), color
...
mysql> CREATE TABLE J (J# CHAR(4) NOT NULL, Jname CHAR(10), City
    -> CHAR(15));
Query OK, 0 rows affected (0.03 sec)
...
| id | select_type | table | partitions | type | possible_keys | key  | key_len | ref  | rows | filtered | Extra |
+----+-------------+-------+------------+------+---------------+------+---------+------+------+----------+-------+
|  1 | SIMPLE      | J     | NULL       | ALL  | NULL          | NULL | NULL    | NULL |    1 |   100.00 | NULL  |
+----+-------------+-------+------------+------+---------------+------+---------+------+------+----------+-------+
1 row in set, 1 warning (0.00 sec)



mysql> CREATE TABLE sp (S# CHAR(4) NOT NULL, P# CHAR(4) NOT NULL, J#
...
| id | select_type | table | partitions | type | possible_keys | key  | key_len | ref  | rows | filtered | Extra |
+----+-------------+-------+------------+------+---------------+------+---------+------+------+----------+-------+
|  1 | SIMPLE      | sp    | NULL       | ALL  | NULL          | NULL | NULL    | NULL |    1 |   100.00 | NULL  |
+----+-------------+-------+------------+------+---------------+------+---------+------+------+----------+-------+
1 row in set, 1 warning (0.00 sec)



mysql> source C:\Users\prajw\OneDrive\Desktop\sunbeamhinjewadi\rdbms-DB\databases\new-hr-db.sql
...
mysql> source C:\Users\prajw\OneDrive\Desktop\sunbeamhinjewadi\rdbms-DB\databases\sales-db.sql
